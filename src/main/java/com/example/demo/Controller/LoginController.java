...
public class LoginController {
	 ...
	 * 
	 * ModelAndView modelAndView = new ModelAndView(); //System.out.println(user);
	 * User userExists = userService.findUserByEmail(user.getEmail()); if
	 * (userExists != null) { bindingResult .rejectValue("email", "error.user",
