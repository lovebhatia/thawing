...
public class DBFileStorageService {
    ...
    */
/*
     * public DBFile storeFile(MultipartFile file,Long id) { // Normalize file name
     ...
     * dbFile.setQuestions(questions); return dbFileRepository.save(dbFile);
    ...
    */
/*public DBFile storeFile1(MultipartFile file) {
        // Normalize file name
        String fileName = StringUtils.cleanPath(file.getOriginalFilename());
